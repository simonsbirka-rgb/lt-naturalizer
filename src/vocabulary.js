...
const FUNCTION_WORDS = [
  ...
  "ir", "o", "bet", "taip", "ne", "ar", "kad", "jei", "kol", "nes", "nors", "kai", "kuomet",
  // Relative pronouns
  "kur", "kurie", "kuris", "kurios", "kuri",
  // Personal pronoun forms (genitive/dative/etc.)
  "jo", "jos", "jų", "jam", "jai", "jiems", "joms",
  // Nominative pronouns
  "jis", "ji", "jie",
  "aš", "tu", "mes", "jūs",
  "man", "tau", "mums", "jums",
  "mane", "tave", "mus", "jus",
  // Prepositions
  "į", "iš", "su", "ant", "po", "prie", "tarp", "per", "apie", "iki", "nuo", "už", "be", "dėl",
  // Demonstratives & connectors
  "tam", "tai", "tada",
  // Adverbs
  "dabar", "visada", "dažnai", "kartais", "niekada", "visai",
  "tik", "tikrai", "gerai", "blogai", "labai", "gana", "pakankamai",
  "daug", "mažai", "truputį",
  // Indefinite/interrogative pronouns
  "viską", "viskas", "nieko", "kažkas",
  "kas", "ką", "kodėl", "kaip", "kiek",
];
